...
<style>
.bar-rows{display:flex;flex-direction:column;gap:9px;max-width:560px;margin:0 auto;font-size:0.82rem;}
.bar-row{display:flex;align-items:center;gap:10px;}
.bar-name{flex:0 0 110px;text-align:right;opacity:.85;}
.bar-track{flex:1 1 auto;position:relative;height:18px;border-right:1.5px dashed rgba(128,128,128,0.55);}
.bar-fill{height:100%;border-radius:2px;}
.bar-val{flex:0 0 44px;font-variant-numeric:tabular-nums;opacity:.85;}
.bar-opt{max-width:560px;margin:0 auto 2px;text-align:right;font-size:0.72rem;opacity:.55;padding-right:44px;}
</style>
<div class="bar-opt">optimal</div>
<div class="bar-rows">
  <div class="bar-row"><div class="bar-name">full \(h\)</div><div class="bar-track"><div class="bar-fill" style="width:94.7%;background:rgba(228,26,28,0.82);"></div></div><div class="bar-val">0.345</div></div>
